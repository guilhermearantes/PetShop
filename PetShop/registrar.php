	...
	<div class="modal-body">
			<form class="form-horizontal loginFrm" method="post" action="cadastroCliente.php" name="cadastrar">
			  <div class="control-group">								
				Digite seu nome:</br> <input type="text" id="id_nome" name="nome" placeholder="Nome">
			  </div>
			   <div class="c</br>ontrol-group">								
				</br>Digite seu login: </br><input type="text" id="id_login" name="login" placeholder="Login">
			 </div>
			  <div class="control-group">
			</br>	Digite sua senha: </br><input type="password" id="id_senha" name="senha" placeholder="Senha">
			  </div></br>
